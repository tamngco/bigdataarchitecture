...
def doImport():
    ...
    command = """INSERT INTO logistics_bi.orders
                 SELECT *
                 FROM s3('http://nginx:9000/gold/orders.csv', 'LylKyYWSyQzErR3pSXaa','gdu1sWlu5BPhbskEazDeIOJSv3ZCxwuTrXqAKTkb', 'CSVWithNames')"""

    client.command(command)


with DAG(
    dag_id='import_data_minio_to_clickhouse_v4',
